...
class RegraController {
    index(req, res) {
        let query = req.query;
        fs.readFile(__dirname + '/../../src/database.json', 'utf8', (err, data) => {
            if (err) {
    ...
    store(req, res) {
        ...
        fs.readFile(__dirname + '/../../src/database.json', 'utf8', (err, data) => {
            ...
            if (file.regras.length == 0) {
                ...
                fs.writeFile(__dirname + '/../../src/database.json', json, 'utf8', (err) => {
                    if (err) {
                        return res.status(400).json({ msg: 'Algum erro inesperado aconteceu, aguarde um momento e tente novamente.' });
                    }
                });
    ...
    delete(req, res) {
        ...
        fs.readFile(filePath, 'utf8', (err, data) => {
            ...
            fs.writeFile(__dirname + '/../../src/database.json', JSON.stringify(final), 'utf8', (err) => {
                if (err) {
                    return res.status(400).json({ msg: 'Algum erro inesperado aconteceu, aguarde um momento e tente novamente.' });
                }
                if (controle) {
...
exports.default = new RegraController();
//# sourceMappingURL=regra-controller.js.map